...
import study.charlieZip.domain.member.dto.LoginForm;
import study.charlieZip.domain.member.entity.Member;
import study.charlieZip.domain.member.service.LoginService;
...
public class LoginController {
    ...
    public String login(@Valid @ModelAttribute("loginForm") LoginForm form, BindingResult bindingResult,
        ...
        session.setAttribute(GlobalConst.LOGIN_MEMBER, loginMember);
